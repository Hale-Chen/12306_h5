$(function () {
    ...
    for (var i = 0; i < provinceList.length; i++) {
        ...
        $("#province-select").append("<option value='" + provinceId + "'>" + provinceName + "</option>");
    }
        ...
        for (var m = 0; m < cityList.length; m++) {
            ...
            if (city.label == city_name) {
                ...
                for (var a = 0; a < areaList.length; a++) {
                    ...
                    $("#area-select").append("<option value='" + areaId + "'>" + areaName + "</option>");
                }
            }
        }
        $("#area-select").selectpicker("refresh");
    });
